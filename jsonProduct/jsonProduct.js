...
function call(){
  ...
  var jsonObj = makeGrid.sortJson(input,jsonObject);
  makeGrid.removeBlocks(jsonObj);
  makeGrid.displayBlocks(jsonObj);
}
//called on window load
window.onload = function(){
  makeGrid.displayBlocks(jsonObject);
}
function jsonGrid(){
//function to display the blocks...
  ...
  this.removeBlocks = function(jsonObj){
    for(var i = 0; i< jsonObj.length; i++){
      var outerDiv = document.getElementById('container');
  ...
  this.sortJson = function(key,jsonObj){
